...
type ProductNft_init_args = {
  $$type: 'ProductNft_init_args';
  _productOwner: Address;
}

function initProductNft_init_args(src: ProductNft_init_args) {
  return (builder: Builder) => {
      let b_0 = builder;
      b_0.storeAddress(src._productOwner);
  };
}

async function ProductNft_init(_productOwner: Address) {
  const __code = Cell.fromBase64('');
  const __system = Cell.fromBase64('');
  let builder = beginCell();
  builder.storeRef(__system);
  builder.storeUint(0, 1);
  initProductNft_init_args({ $$type: 'ProductNft_init_args', _productOwner })(builder);
  const __data = builder.endCell();
  return { code: __code, data: __data };
}

const ProductNft_errors: { [key: number]: { message: string } } = {
...
const ProductNft_types: ABIType[] = [
...
const ProductNft_getters: ABIGetter[] = [
  {"name":"getNftAddress","arguments":[{"name":"_nftId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
  {"name":"getNftInit","arguments":[{"name":"_nftId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"StateInit","optional":false}},
  {"name":"getNftAddresses","arguments":[],"returnType":{"kind":"dict","key":"int","value":"address"}},
  {"name":"getTestInternal","arguments":[{"name":"_nftId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":null},
  {"name":"nftId","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
  {"name":"nftExists","arguments":[{"name":"_nftId","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"bool","optional":false}},
]

export const ProductNft_getterMapping: { [key: string]: string } = {
  'getNftAddress': 'getGetNftAddress',
  'getNftInit': 'getGetNftInit',
  'getNftAddresses': 'getGetNftAddresses',
  'getTestInternal': 'getGetTestInternal',
  'nftId': 'getNftId',
  'nftExists': 'getNftExists',
}

const ProductNft_receivers: ABIReceiver[] = [
  {"receiver":"internal","message":{"kind":"typed","type":"InitNft"}},
  {"receiver":"internal","message":{"kind":"typed","type":"CheckNftExists"}},
  {"receiver":"internal","message":{"kind":"typed","type":"ChangeOwner"}},
  {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class ProductNft implements Contract {
  
  static async init(_productOwner: Address) {
      return await ProductNft_init(_productOwner);
  }
  
  static async fromInit(_productOwner: Address) {
      const init = await ProductNft_init(_productOwner);
      const address = contractAddress(0, init);
      return new ProductNft(address, init);
  }
  
  static fromAddress(address: Address) {
      return new ProductNft(address);
  }
  
  readonly address: Address; 
  readonly init?: { code: Cell, data: Cell };
  readonly abi: ContractABI = {
      types:  ProductNft_types,
      getters: ProductNft_getters,
      receivers: ProductNft_receivers,
      errors: ProductNft_errors,
  };
  ...
  async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: InitNft | CheckNftExists | ChangeOwner | Deploy) {
      ...
      if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CheckNftExists') {
          body = beginCell().store(storeCheckNftExists(message)).endCell();
      }
  ...
  async getGetNftAddress(provider: ContractProvider, _nftId: bigint) {
      let builder = new TupleBuilder();
  ...
  async getGetNftInit(provider: ContractProvider, _nftId: bigint) {
      let builder = new TupleBuilder();
      builder.writeNumber(_nftId);
      let source = (await provider.get('getNftInit', builder.build())).stack;
      const result = loadGetterTupleStateInit(source);
      return result;
  }
  
  async getGetNftAddresses(provider: ContractProvider) {
      let builder = new TupleBuilder();
      let source = (await provider.get('getNftAddresses', builder.build())).stack;
      let result = Dictionary.loadDirect(Dictionary.Keys.BigInt(257), Dictionary.Values.Address(), source.readCellOpt());
      return result;
  }
  
  async getGetTestInternal(provider: ContractProvider, _nftId: bigint) {
      let builder = new TupleBuilder();
      builder.writeNumber(_nftId);
      let source = (await provider.get('getTestInternal', builder.build())).stack;
  }
  
  async getNftId(provider: ContractProvider) {
      let builder = new TupleBuilder();
      let source = (await provider.get('nftId', builder.build())).stack;
      let result = source.readBigNumber();
      return result;
  }
  
  async getNftExists(provider: ContractProvider, _nftId: bigint) {
      let builder = new TupleBuilder();
      builder.writeNumber(_nftId);
      let source = (await provider.get('nftExists', builder.build())).stack;
